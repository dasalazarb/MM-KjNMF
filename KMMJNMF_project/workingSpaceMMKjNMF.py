...
if args.Rpath == None:
    ...
    param_grid = {'K': [20],
                  ...
                  'd1': [1e-5], 'o1': [10], 'o2': [100],
                  'sigma_ccle': [1], 'sigma_tcga': [1],
                  'sigma_ccle_diff': [1], 'sigma_tcga_diff': [2]
                  };
    print(param_grid)
    print("")
    print("")
...
param_grid = {'K': [20],
              ...
              # 'd1': [1e-3], 'o1': [1e-7], 'o2': [1e-7],
              'd1': [0], 'o1': [1], 'o2': [1],
              'sigma_ccle': [4], 'sigma_tcga': [4],
              'sigma_ccle_diff': [4], 'sigma_tcga_diff': [4]
              };
...
for params in grid:
    ...
    paramResultKernels["module_patient_cell_v2"]
# %%
